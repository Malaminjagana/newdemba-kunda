...
villageHistoryData = {
    ...
    locations: [
        ...
        { id: 'arabic-schools', name: 'Arabic Schools', category: 'Education', markerIcon: 'fa-school', mapPosition: [15, 55], coordinates: null, description: 'Traditional primary-school locations and later Arab-Islamic schools are part of the village education record.', historicalSignificance: 'The book documents traditional learning, the Eight Villages’ School and Dar al-Islam al-Salafiya School.', people: ['Sheikh Ibrahima Khonteh'], bookReference: { source: 'The History of New Demba Kunda' }, storyIds: ['traditional-education', 'eight-villages-school', 'dar-al-islam', 'education-beyond-village'] },
        { id: 'english-school', name: 'English School', category: 'Education', markerIcon: 'fa-school', mapPosition: [72, 66], coordinates: null, description: 'An English school was inaugurated in 1998 after community attitudes toward English-language education changed over time.', historicalSignificance: 'The school later expanded to higher grades and, by the period covered by the book, had more than 800 pupils.', people: [], bookReference: { source: 'The History of New Demba Kunda' }, storyIds: ['english-education'] },
        { id: 'historic-wells', name: 'Historic Wells', category: 'Land and water', markerIcon: 'fa-tint', mapPosition: [43, 77], coordinates: null, description: 'Historic wells sustained daily village life before the 2004 borehole water project, including the recorded well Khuban Ghede.', historicalSignificance: 'The project reduced the burden of collecting water through a borehole, two 60,000-litre tanks and 74 taps.', people: [], bookReference: { source: 'The History of New Demba Kunda' }, storyIds: ['historic-wells', 'water-project'] },
        { id: 'farms-gardens', name: 'Farms and Gardens', category: 'Community life', markerIcon: 'fa-seedling', mapPosition: [24, 76], coordinates: null, description: 'Agriculture and gardening are part of the book’s record of women’s roles in household life and community development.', historicalSignificance: 'The archive records these contributions without reducing women’s work to a single role.', people: [], bookReference: { source: 'The History of New Demba Kunda' }, storyIds: ['women-community'] },
        { id: 'lost-villages', name: 'Lost Villages', category: 'Lost history', markerIcon: 'fa-landmark', mapPosition: [73, 29], coordinates: null, description: 'The book records Tenkinam, Tobali Kunda, Jinna Wurunde, Biraima Kaara, Simbanou, Koba Kaara, Sirihin Kaara and Tumbun Khore.', historicalSignificance: 'Their locations are not placed as geographic coordinates because verified coordinates are not yet documented.', people: [], bookReference: { source: 'The History of New Demba Kunda' }, storyIds: ['lost-villages'] }
    ],
    events: [
...
(function (data) {
    ...
    [
        ...
        ['demba-kunda-nyale', 'Demba Kunda Nyale', [78, 18], 'A neighbouring village documented in the Eight Villages’ School record.'],
        ...
        ['basse', 'Basse', [96, 56], 'The nearest city reference used in the documented Bassen Kille farmland record.']
    ...
    [
        ...
        ['darbon-ghede', 'DARBON GHEDE', [67, 42], 'An east-side well dug by Sikhou Darbo; the book describes fresh water and later rebuilding by Sharif Jagana.'],
    ...
    [
        ['dala-gilleh', 'Dala Gilleh', [13, 61], 'A documented pond and forest area on the Gambisara road.'],
        ['hurunkun-dala', 'Hurunkun Dala', [20, 67], 'A documented pond.'], ['dala-lemmeh', 'Dala Lemmeh', [26, 60], 'A documented pond.'], ['jamban-dala', 'Jamban Dala', [18, 74], 'A documented pond.'], ['simakhan-dala', 'Simakhan Dala', [25, 82], 'A documented pond.'], ['kumma-kejugun-dala', 'Kumma Kejugun Dala', [15, 84], 'A documented pond.'], ['dala-khore', 'Dala Khore', [8, 72], 'A documented pond.'], ['sikhou-hounen-dala', 'Sikhou Hounen Dala', [11, 66], 'A documented pond.'], ['khilin-dala', 'Khilin Dala', [20, 89], 'A documented pond.'], ['saban-dala', 'Saban Dala', [29, 87], 'A documented pond.'], ['khumba-janken-dala', 'Khumba Janken Dala', [32, 82], 'A documented pond.']
    ].forEach(function (entry) { add(entry[0], entry[1], 'Ponds / Water Features', 'fa-water', entry[2], entry[3]); });
    ['Haaja', 'Bilalin Saro', 'Bassen Kille', 'Giden Kamma', 'Saro', 'Jalihara', 'Sabin Sagandu', 'Dandinghari', 'Ban Saro', 'Biraima Kaara', 'Simbanou', 'Tobali Kunda', 'Jinna Wurunde', 'Sirihin Kaara', 'Tumbun Khore', 'Tenkinam', 'Dindi Hori', 'Ha Dugu', 'Khole Halle', 'Tellutu', 'Numuyelin Tenu'].forEach(function (name, index) { add('farmland-' + index, name, 'Farmlands', 'fa-seedling', [8 + (index % 7) * 13, 79 + Math.floor(index / 7) * 7], 'A documented farming area.', 'This position is illustrative and represents a documented farming landscape, not a verified boundary.'); });
    ['Ha Dugu', 'Dala Gilleh', 'American Diga', 'Khole Halle Giden Kamma', 'Hulundumbu', 'Simbanou'].forEach(function (name, index) { add('forest-' + index, name, 'Forests', 'fa-tree', [13 + index * 14, 91], 'A documented nearby forest area.', 'This position is illustrative and represents a documented forest landscape, not a verified boundary.'); });
    add('kholi-khore-bridge', 'Kholi Khore Bridge', 'Historic Infrastructure', 'fa-archway', [12, 43], 'A bridge at Kholi Khore was built around 1966.', 'This bridge is connected to the documented Kholi Khore stream section; its map position is illustrative.');
...
(function (data) {
    ...
    traditionalSchools.forEach(function (name, index) {
        ...
        addLocation({ id: 'traditional-school-' + index, name: name, category: 'Traditional Schools', markerIcon: 'fa-school', mapPosition: educationPositions[index], positionType: 'illustrative', coordinates: null, description: 'A documented traditional primary-school location where students learned Arabic, reading, writing and Qur’an.', historicalSignificance: 'This illustrative map record represents one of the 17 documented traditional primary-school locations.', people: [], bookReference: { source: source }, storyIds: ['traditional-education'], familyId: matchingFamily ? matchingFamily.familyId : null, mapLocationId: matchingFamily ? matchingFamily.mapLocationId : null });
    });
    [
...
(function (data) {
    ...
    [
        ['dibirou', 'Dibirou', [86, 75], 'About 10 km southeast; established around 1937 by people who had lived in New Demba Kunda.', 'The distance and direction are documented; this map position is illustrative.', ['village-centre']],
        ['jidda-moudou', 'Jidda Moudou', [48, 98], 'About 6 km south; established around 1946 by people who had lived in New Demba Kunda.', 'The distance and direction are documented; this map position is illustrative.', ['village-centre']],
        ['simbi', 'Simbi', [12, 94], 'About 12 km southwest; established around 1950 by people who had lived in New Demba Kunda.', 'The distance and direction are documented; this map position is illustrative.', ['village-centre']]
    ].forEach(function (entry) { add(entry[0], entry[1], 'Outgrowth Villages', entry[2], entry[3], entry[4], entry[5]); });
    add('kholi-khore', 'Kholi Khore', 'Water', [13, 43], 'A documented section of the village stream.', 'This map position is illustrative and connects the stream record with the historic bridge.', ['kholi-khore-bridge', 'gambisara']);
    data.features.push(
