...
villageHistoryData = {
    ...
    locations: [
        ...
        { id: 'english-school', name: 'English School', category: 'Education', markerIcon: 'fa-school', mapPosition: [72, 66], coordinates: null, description: 'An English school was inaugurated in 1998 after community attitudes toward English-language education changed over time.', historicalSignificance: 'The school later expanded to higher grades and had more than 800 pupils by the period described.', people: [], bookReference: { source: 'The History of New Demba Kunda' }, storyIds: ['english-education'], media: { historicalImages: englishSchoolMedia } },
